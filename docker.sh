...
# Babysitter Docker Sandbox Management Script
# Usage:
...
CONTAINER_NAME="babysitter-sandbox"
IMAGE="alpine:latest"
...
case "$1" in
  create)
    ...
    if [ $? -eq 0 ]; then
      ...
      echo ""
      echo "Run babysitter with: babysitter --sandbox=docker:${CONTAINER_NAME} $2"
    else
  ...
  *)
    echo "Babysitter Docker Sandbox Management"
    echo ""
