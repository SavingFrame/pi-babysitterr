...
const BABYSITTER_SLACK_APP_TOKEN = process.env.BABYSITTER_SLACK_APP_TOKEN;
const BABYSITTER_SLACK_BOT_TOKEN = process.env.BABYSITTER_SLACK_BOT_TOKEN;
...
if (parsedArgs.downloadChannel) {
	if (!BABYSITTER_SLACK_BOT_TOKEN) {
		console.error("Missing env: BABYSITTER_SLACK_BOT_TOKEN");
		process.exit(1);
	}
...
const bot = new SlackBotClass(handler, {
	appToken: BABYSITTER_SLACK_APP_TOKEN,
	botToken: BABYSITTER_SLACK_BOT_TOKEN,
	workingDir,
	store: sharedStore,
});
